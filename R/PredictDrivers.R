...
#a household type is a Driver is the ratio of Drivers to persons in that age
#group and household type. For the noninstitutionalized group quarters
#population, the probability is the ratio of Drivers to persons by age group.
...
#' }
#' @source PredictDrivers.R script.
...
#=======================================================
#This function predicts the number of Drivers in each of 6 age groups in each
...
#probabilities for determining the number of Drivers by age group for each
#household.

#Main module function that predicts Drivers by age for each household
#--------------------------------------------------------------------
#' Main module function to predict Drivers by age for each household
#'
#' \code{PredictDrivers} predicts the number of Drivers by age group for each
#' household and tallies the total number of Drivers for each household.
#'
#' This function predicts the number of Drivers for each household. Household
#' Drivers are assigned to 5 age groups: 15-19, 20-29, 30-54, 55-64, and 65Plus.
#'
