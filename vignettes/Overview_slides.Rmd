...
- Updating models with the latest and best data available
    - model AADVMT instead of DVMT taking advantage of AADVMT in NHTS2009
...
- Uses the `predict` method dispatch of R model objects for prediction, simplifying code complexity
...
1. Project reports and manuscript under review of publication
...
- Size: currently at 54.2Mb, 
   - 25.3Mb data, with the model objects for 9 models take up most of the space
   - 28.7Mb external data, PlaceType.Rda taking up most
...
- Responses to VisionEval Contribution Review Criteria
